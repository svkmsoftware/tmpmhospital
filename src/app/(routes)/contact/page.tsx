...
const defaultContactItems = [
  ...
  { icon: Phone,   label: "Call Us",    value: "02563 351503/04"            },
  { icon: Phone,   label: "Radiology",    value: "02563 351503/04"            },
...
export default async function ContactPage() {
  ...
  return (
    <>
      <PageBanner image="/images/departments_banner_new_2.png" title="Contact Us"

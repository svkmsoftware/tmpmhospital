...
export const metadata: Metadata = {
  ...
  keywords: [
    "TMPM Hospital",
    "SVKM Hospital",
    "Tapanbhai Mukeshbhai Patel Hospital",
    "Shirpur hospital",
    "multispecialty hospital Maharashtra",
    "best hospital Shirpur",
    "hospital Dhule",
    "tribal healthcare Maharashtra",
  ...
  verification: {
    google: "6esUDsnHXjqAUOWn04XIe-9RABx4nEENk_Dj0wL1QQM",
  },
  openGraph: {
    type: "website",
    locale: "en_IN",

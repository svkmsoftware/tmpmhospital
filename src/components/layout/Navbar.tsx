...
//             : "text-neutral-600 hover:text-cyan-700 hover:bg-cyan-50",
//         )}
//       >
//         {item.label}
//       </Link>
...
//       <div
//         className={cn(
//           "bg-white border-b border-neutral-100 transition-shadow duration-300",
//           scrolled && "shadow-sm",
//         )}
//       >
...
//             <Link
//               href="/contact"
//               className="hidden sm:inline-flex btn-gradient text-sm py-2 px-4"
//             >
//               Book Appointment
//             </Link>
...
//           {navItems.map((item, i) => (
//             <MobileNavItem key={i} item={item} onClose={closeMobile} />
//           ))}
//         </div>
...
function DesktopNavItem({
  ...
  if (!item.children) {
    return (
      <Link
        href={item.href!}
        className={cn(
          "px-2.5 xl:px-3 2xl:px-4 py-2 text-sm 2xl:text-[15px] font-medium rounded-xl transition-all duration-150 whitespace-nowrap",
          isActive
            ? "text-cyan-700 bg-cyan-50"
            : "text-neutral-600 hover:text-cyan-700 hover:bg-cyan-50",
        )}
  ...
  return (
    ...
    >
      <button
        className={cn(
          "flex items-center gap-1 px-2.5 xl:px-3 2xl:px-4 py-2 text-sm 2xl:text-[15px] font-medium rounded-xl transition-all duration-150 whitespace-nowrap",
          isActive || open
            ? "text-cyan-700 bg-cyan-50"
            : "text-neutral-600 hover:text-cyan-700 hover:bg-cyan-50",
        )}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "var(--gradient-main)" }}
      >
        <div className="w-full flex items-center justify-between py-1.5 px-4 sm:px-6 lg:px-10 xl:px-14 2xl:px-20">
          <div className="flex items-center gap-5 text-xs text-cyan-100">
            <a
              href="mailto:contact@tmpmhospital.com"
              className="flex items-center gap-1.5 hover:text-white transition-colors"
      ...
      >
        <div className="w-full flex items-center justify-between h-16 px-4 sm:px-6 lg:px-10 xl:px-14 2xl:px-20">
          <Link
            href="/"
            className="flex items-center gap-3 shrink-0"
            aria-label="SVKM TMPM Hospital — Home"
          ...
          <nav
            className="hidden xl:flex items-center gap-1 2xl:gap-2 flex-1 justify-center"
            aria-label="Main navigation"
          >
            {navItems.map((item, i) => {
              const isActive =
          ...
          <div className="flex items-center gap-3 xl:gap-4 shrink-0">
            ...
            <Link
              href="/contact"
              className="hidden sm:inline-flex btn-gradient text-sm py-2 px-4 whitespace-nowrap"
            >
              Book Appointment
            </Link>

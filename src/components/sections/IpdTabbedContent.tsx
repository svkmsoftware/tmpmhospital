...
const ICON_RULES: Array<{ keywords: string[]; Icon: typeof BedDouble }> = [
  { keywords: ["icu", "critical", "intensive"], Icon: HeartPulse },
  { keywords: ["nurs"], Icon: ClipboardList },
  { keywords: ["emergency", "trauma"], Icon: Activity },
  { keywords: ["dialysis", "renal"], Icon: Droplet },
  {
    keywords: ["paediatric", "pediatric", "child", "nicu", "picu"],
    Icon: Baby,
  },
  { keywords: ["surgery", "surgical", "operation"], Icon: Syringe },
  { keywords: ["room", "ward", "bed", "accommodation"], Icon: BedDouble },
  { keywords: ["consult", "doctor", "specialist"], Icon: Stethoscope },
  { keywords: ["safety", "quality", "infection"], Icon: ShieldCheck },
  { keywords: ["family", "visitor", "support"], Icon: Users },
];
const FALLBACK_ICONS = [Stethoscope, HeartPulse, ClipboardList, Sparkles];
...
export default function IpdTabbedContent({ data }: { data: TabItem[] }) {
  ...
  return (
    ...
    >
      ...
      <nav aria-label="IPD services" className="lg:sticky lg:top-28 self-start">
          ...
          >
            <div className="flex items-center gap-2.5 mb-4 flex-wrap">
              ...
              <span
                ...
                style={{ color: "#08A2A4" }}
              >
                IPD Service {String(activeTab + 1).padStart(2, "0")} /{" "}
